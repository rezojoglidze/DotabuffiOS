...
extension UIViewController {
    ...
    func startLoading() {
        if view.viewWithTag(1000) == nil {
            ...
            view.addConstraints([
                animationBackgroundView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
                animationBackgroundView.topAnchor.constraint(equalTo: view.topAnchor),
                animationBackgroundView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
                animationBackgroundView.bottomAnchor.constraint(equalTo: view.bottomAnchor),
